-- Add profile_complete, consent_500_sakhi, consent_serve_sakhi_50; make father_husband_name nullable (run in SQL editor)
ALTER TABLE mahila_samman_submissions ADD COLUMN IF NOT EXISTS consent_500_sakhi BOOLEAN DEFAULT false;
ALTER TABLE mahila_samman_submissions ADD COLUMN IF NOT EXISTS consent_serve_sakhi_50 BOOLEAN DEFAULT false;
